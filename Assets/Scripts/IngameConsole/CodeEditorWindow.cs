...
public class CodeEditorWindow : MonoBehaviour
{
    ...
    public void Hide()
    {
        gameObject.SetActive(false); // Скрываем окно редактора
    ...
    private void Start()
    {
        // Настраиваем кнопку выполнения кода
        runButton.onClick.AddListener(OnRunButtonClicked);

        // Добавляем обработчик изменения текста с задержкой
    ...
    private async void OnRunButtonClicked()
    {
        ...
        Hide(); // Закрываем окно после выполнения кода
    }
